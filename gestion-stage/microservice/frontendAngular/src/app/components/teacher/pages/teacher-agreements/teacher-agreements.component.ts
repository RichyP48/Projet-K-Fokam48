...
@Component({
  selector: 'app-teacher-agreements',
  standalone: true,
  imports: [CommonModule, RouterLink],
  template: `
    <div class="container mx-auto px-4 py-8">
      <div class="mb-6">
        <a routerLink="/teacher" class="inline-flex items-center text-primary-600 hover:text-primary-800">
      ...
      <h1 class="text-3xl font-bold text-gray-900 mb-6">Conventions de mes étudiants</h1>
      ...
      <div *ngIf="!loading" class="space-y-4">
        <div *ngIf="conventions.length === 0" class="bg-white rounded-lg shadow p-8 text-center">
          ...
          <p class="text-gray-500">Aucune convention d'étudiant à superviser.</p>
        </div>
        ...
        <div *ngFor="let convention of conventions" class="bg-white rounded-lg shadow-md p-6">
          ...
          <div class="mb-4">
            <p class="text-sm font-medium text-gray-700 mb-2">État des validations</p>
            <div class="grid grid-cols-2 gap-4">
              ...
              <div class="flex items-center">
                ...
                <span class="text-sm text-gray-600">Ma validation</span>
              </div>
              <div class="flex items-center">
          ...
          <div class="flex space-x-2">
            ...
            <button *ngIf="!convention.signedByFaculty" 
...
export class TeacherAgreementsComponent implements OnInit {
  conventions: any[] = [];
  loading = false;
  ...
  validateConvention(convention: any): void {
    const enseignantId = 2; // TODO: Récupérer depuis le JWT
    this.conventionService.validateConvention(convention.id, enseignantId).subscribe({
      next: () => {
        convention.signedByFaculty = true;
